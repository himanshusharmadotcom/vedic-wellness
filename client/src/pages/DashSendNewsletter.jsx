...
export default function DashSendNewsLetter() {
  return (
    <Wrapper>
          ...
          <form>
            ...
            <div className='form-row-full'>
              <div className="consent-span">
                <input type="checkbox" checked /> <p>I confirm to send this email to all the subscibers from example@gmail.com </p>
              </div>
            </div>
            <div className='form-row-full'>
              <input type="submit" value='Send' className='input-class' />
            </div>
          </form>
        </div>
      </div>
